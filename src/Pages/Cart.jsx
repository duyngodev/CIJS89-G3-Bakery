...
const Cart = (props) => {
    ...
    //     const newStateCart = data?.filter((cartItem) => cartItem.id !== id);
    //     localStorage.setItem("cart", JSON.stringify(newStateCart));
    //     // setData(newStateCart); // Nếu cần cập nhật Redux store thì sử dụng dispatch
    // };

    // const decreaseBtClickHandler = (cartItem) => {
    //     const indexElement = data?.findIndex((cartItemLoop) => cartItemLoop.id === cartItem.id);
    ...
    //     // setData(cartNewState); // Nếu cần cập nhật Redux store thì sử dụng dispatch
    // };
